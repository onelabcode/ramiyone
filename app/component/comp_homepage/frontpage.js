...
const Frontpage = () => {
  const typedText = useTypewriter("advanced scouting platform.", 60, 100, 4000, 4000);
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6 text-center md:text-left">
              ...
              <p className="text-base sm:text-lg text-gray-700 max-w-md mx-auto md:mx-0">
                Discover the next generation of football talent with our {typedText}|
              </p>
            ...
            <div className="space-y-4">
              <Card className="p-4 rounded-lg shadow-lg border border-gray-200">
                <CardHeader>
                  ...
                  <CardTitle className="text-lg font-semibold mt-4">Elite Talent Pool</CardTitle>
                </CardHeader>
                <CardContent className="text-gray-600">
                  Access to a curated database of promising young football talents.
                </CardContent>
              </Card>
              ...
              <Card className="p-4 rounded-lg shadow-lg border border-gray-200">
                <CardHeader>
                  ...
                  <CardTitle className="text-lg font-semibold mt-4">Advanced Analytics</CardTitle>
                </CardHeader>
                <CardContent className="text-gray-600">
              ...
              <Card className="p-4 rounded-lg shadow-lg border border-gray-200">
                <CardHeader>
                  ...
                  <CardTitle className="text-lg font-semibold mt-4">Scout Network</CardTitle>
                </CardHeader>
                <CardContent className="text-gray-600">
