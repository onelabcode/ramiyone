    ...
    <div className="mb-8">
              ...
              <div className="flex items-center gap-2 mt-1">
               ...
               src={`https://flagcdn.com/w320/${processCountryName(
                topPlayer.nationality
                  ...
                  className="w-6 h-4"
                />
                <span className="text-sm text-muted-foreground">{topPlayer.team_name}</span>
              </div>
            </CardContent>
          </Card>
        ) : (
      ...
      <div className="mt-4 flex justify-end">
        <button
          ...
          disabled={!topPlayer}
          className={`px-6 py-2 text-white font-bold rounded-lg ${topPlayer ? "bg-blue-500 hover:bg-blue-600" : "bg-gray-300"}`}
        >
          Submit
        </button>
      </div>
