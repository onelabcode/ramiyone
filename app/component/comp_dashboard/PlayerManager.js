...
export default function PlayerManager() {
  ...
  return (
    <div className="px-10 max-h-screen">
                ...
                >
                  ...
                  <td className="px-4 py-4 whitespace-nowrap">
                    <div className="flex gap-2">
                      ...
                      <Button
                        onClick={() => handleDeleteConfirmation('player', player)}
                        variant="outline"
                        size="sm"
                ...
                <td colSpan="7" className="text-center py-6 text-gray-600">
                  <div className="flex flex-col items-center justify-center">
                    ...
                    <p className="text-sm text-gray-500">
                      It seems no players have been created yet. Add new players to see them listed here.
                    </p>
                  </div>
                </td>
              </tr>
      ...
      <AlertDialog open={deleteConfirmation.isOpen} onOpenChange={(isOpen) => !isOpen && setDeleteConfirmation({ isOpen: false, type: null, item: null })}>
        <AlertDialogContent>
          <AlertDialogHeader>
