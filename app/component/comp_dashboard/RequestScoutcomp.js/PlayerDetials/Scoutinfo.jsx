    ...
    <Card className="p-6">
      <Tabs defaultValue="scout" className="space-y-6">
        <TabsList className="w-full">
          <TabsTrigger value="scout" className="flex-1">Scout information</TabsTrigger>
          <TabsTrigger value="player" className="flex-1">Player information</TabsTrigger>
        </TabsList>
        ...
        <TabsContent value="scout" className="space-y-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h3 className="text-lg font-semibold">Name : {singleScout.name}</h3>
              <p className="text-sm text-gray-500">email : {singleScout.email}</p>
            </div>
          </div>
        ...
        <TabsContent value="player" className="space-y-6">
          <div className="flex items-center gap-4">
            <Avatar className="w-16 h-16">
            <Image src={singlePlayer.image} 
         alt={"Img"}
            fill
            className="object-cover transition-transform duration-300 group-hover:scale-110"/>
            </Avatar>
            <div>
              <h3 className="text-lg font-semibold">Name : {singlePlayer.player_id}</h3>
            </div>
          </div>
