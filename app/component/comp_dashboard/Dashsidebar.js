...
const navItems = [
  { id: 1, icon: <LayoutDashboard size={20} />, label: 'Dashboard', page: 'Overview' },
  { id: 2, icon: <Users size={20} />, label: 'Manager', page: 'PlayerManager' },
  { id: 3, icon: <Filter size={20} />, label: 'Filter', page: 'Explorefilter' },
  { id: 4, icon: <CheckCircle size={20} />, label: 'Suggested Players', page: 'PlayerApprove' },
  { id: 5, icon: <UserPlus size={20} />, label: 'Scout Request', page: 'PlayerRequests' },
  { id: 6, icon: <Mail size={20} />, label: 'Request', page: 'RequestScoute' },
  { id: 7, icon: <CalendarDays size={20} />, label: 'Trial Request', page: 'trialout' },
  { id: 8, icon: <Edit3 size={20} />, label: 'Content', page: 'ContentCreation' },
  { id: 9, icon: <Newspaper size={20} />, label: 'Transfer News', page: 'TransferNews' },
  { id: 10, icon: <Building size={20} />, label: 'Club News', page: 'ClubNewsDashboard' },
  { id: 11, icon: <UserCog size={20} />, label: 'Managers', page: 'ManagerDash' },
  { id: 12, icon: <Layout size={20} />, label: 'Brand Logo', page: 'BrandLogo' },
  { id: 13, icon: <PieChart size={20} />, label: 'Announcements', page: 'Announcement' },
        ...
        <TooltipProvider>
          {navItems.map((item) => (
            <Tooltip key={item.id} delayDuration={0}>
              ...
              {isCollapsed && (
                <TooltipContent side="right" className="ml-1 text-sm text-white bg-gray-800 rounded-md">
                  {item.label}
                </TooltipContent>
              )}
            </Tooltip>
