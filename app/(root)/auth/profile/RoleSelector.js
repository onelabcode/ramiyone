...
const  router = useRouter();
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl mx-auto">
      <Card className="p-6 hover:shadow-lg transition-shadow cursor-pointer" onClick={() => handleRoleSelect("scout")}>
      ...
      <Card className="p-6 hover:shadow-lg transition-shadow cursor-pointer" onClick={() => handleRoleSelect("coach")}>
        <CardContent className="flex flex-col items-center space-y-4 pt-6">
