  ...
  updateManager: async (id, updatedData) => {
    ...
    try {
      ...
      set((state) => ({
        ...
        featuredManager:
          state.featuredManager?.id === id ? response.data : state.featuredManager,
        loading: false,
      }));
  ...
  updateManagerFeaturedStatus: async (id, is_featured) => {
   ...
   set({ loading: true, error: null });
    try {
      ...
      set({ error: 'Failed to update manager featured status', loading: false });
    }
  },
  ...
  deleteManager: async (id) => {
    ...
    try {
      ...
      set((state) => ({
        ...
        featuredManager: state.featuredManager?.id === id ? null : state.featuredManager,
        loading: false,
      }));
