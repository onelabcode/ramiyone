...
export default function TransferNewsPage() {
  ...
  const handleUpdate = async (e) => {
    ...
    console.log(form);
    if (editingTransfer.imageUrl)
      form.append("image", editingTransfer.imageUrl);
            ...
            <Card className="p-12 text-center bg-purple-50/50">
              <div className="flex flex-col items-center gap-3">
                ...
                <p className="text-purple-400">
                  Add your first transfer news item!
                </p>
              </div>
            </Card>
          )}
            ...
            <div className="mb-4">
              ...
              {editingTransfer?.imageUrl && (
                <div className="mt-2">
                  <Image
                    src={
                      typeof editingTransfer.imageUrl === "string"
                        ? editingTransfer.imageUrl
                        : URL.createObjectURL(editingTransfer.imageUrl)
                    }
                    alt="Preview"
                    className="w-20 h-20 object-cover rounded-md"
                    width={80}
