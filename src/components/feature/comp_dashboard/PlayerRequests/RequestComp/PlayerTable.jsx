  ...
  return (
    <div className="space-y-4">
            ...
            <tbody>
              {paginatedRequests.map((request) => (
                ...
                >
                  ...
                  <td className="p-4">
                    <Badge variant={Check}>{request.status}</Badge>
                  </td>
                  <td className="p-4">
                    {request.status === "pending" ? (
                      <div className="flex gap-2">
                        <Button
                          ...
                          onClick={(e) =>
                            handleStatus(e, request.id, "accepted")
                          }
                        >
                        ...
                        <Button
                          ...
                          onClick={(e) =>
                            handleStatus(e, request.id, "declined")
                          }
                        >
                          <X className="h-4 w-4" />
                        </Button>
                      ...
                      <div>
                        <Button
                          ...
                          className="text-red-600 hover:text-red-700 hover:bg-red-50"
                          onClick={(e) =>
                            handleDeleteConfirmation(e, request.id)
                          }
                        >
                          Delete
                        </Button>
      ...
      <AlertDialog
        ...
        onOpenChange={(isOpen) =>
          !isOpen && setDeleteConfirmation({ isOpen: false, requestId: null })
        }
      >
        <AlertDialogContent>
          <AlertDialogHeader>
