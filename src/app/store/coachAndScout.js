...
const useProfileStore = create((set) => ({
  ...
  fetchScoutProfiles: async () => {
    ...
    try {
      ...
      set({ error: error.response?.data?.message || "Failed to fetch scout profiles", loading: false });
    }
  },
  ...
  createScoutProfile: async (data,profile) => {
    ...
    try {
      ...
      set({ error: error.response?.data?.message || "Failed to create scout profile", loading: false });
    }
  },
  ...
  updateScoutProfileStatus: async (id, status,role) => {
    ...
    try {
      ...
      set({ error: error.response?.data?.message || "Failed to update scout profile status", loading: false });
    }
  },
  ...
  deleteScoutProfile: async (id) => {
    ...
    try {
      ...
      set({ error: error.response?.data?.message || "Failed to delete scout profile", loading: false });
    }
  },
